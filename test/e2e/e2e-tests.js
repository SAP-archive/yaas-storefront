  ...
  describe("verify product pages", function () {
    ...
    beforeEach(function () {
      ...
      it('should scroll to load more products', function () {
        ...
        scrollToBottomOfProducts(5000);
        getTextByRepeaterRow(35) //verify last product has loaded
        element(by.css("img[alt=\"Back To Top\"]")).click()        
        testProduct.click();
      ...
      it("should get order products correctly", function () {
        ...
        clickByLinkText('>');
        browser.sleep(500);
        assertTextByRepeaterRow(0, 'DIFFERENT CERAMIC BIRDS (5)');
        clickByLinkText('<');
        browser.sleep(500);
        assertTextByRepeaterRow(0, 'BIRDHOUSE');
        ...
        assertTextByRepeaterRow(0, 'TATTERED BOWLS');
        clickByLinkText('>');
        browser.sleep(500);
        assertTextByRepeaterRow(0, 'BIRDHOUSE');
        clickByLinkText('<');
