...
describe('AnonAuthSvc', function () {
    ...
    var AnonAuthSvc, mockedTokenSvc, mockBackend, $rootScope, accountUrl, siteConfig;
    ...
    beforeEach(inject(function (_AnonAuthSvc_, _$httpBackend_, _$rootScope_, SiteConfigSvc) {
        ...
        accountUrl = siteConfig.apis.customerlogin.baseUrl;
    ...
    describe('getToken()', function () {
        ...
        describe('happy path', function () {
            beforeEach(function () {
                mockBackend.expectPOST(accountUrl + '/auth/anonymous/login')
